...
<?php  
$result_db = mysqli_query($koneksi,"SELECT COUNT(*) as jumlah FROM menu WHERE id_kategori ='2'"); 
...
for ($i=1; $i<=$total_pages; $i++) {
              $pagLink .= "<li class='page-item'><a class='page-link bg-dark text-white' href='kategoriFoodpage.php?page=".$i."'>".$i."</a></li>";	
}
echo $pagLink . "</ul>";  
?>
