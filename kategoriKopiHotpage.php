...
<nav class="navbar navbar-expand-lg navbar-light bg-dark ">
        <div class="container-fluid">
          ...
          <li><a class="dropdown-item fw-bold" href="kategoriKopi Hotpage.php">Kopi Hot</a></li>
...
<?php  
$result_db = mysqli_query($koneksi,"SELECT COUNT(*) as jumlah FROM menu WHERE id_kategori ='1'"); 
...
for ($i=1; $i<=$total_pages; $i++) {
              $pagLink .= "<li class='page-item'><a class='page-link bg-dark text-white' href='kategoriKopi Hotpage.php?page=".$i."'>".$i."</a></li>";	
}
echo $pagLink . "</ul>";  
?>
