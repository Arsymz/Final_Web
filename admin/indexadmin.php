...
$level="admin";
  ...
  $datamenu = $koneksi->query("SELECT COUNT(*) as jumlah FROM menu")->fetch_assoc();
        ...
        <div class="row">
          ...
          <div class="col-lg-3 col-6">
            <div class="small-box bg-warning">
              <div class="inner" style="margin-top:10px; height:100px;">
                 <h4 style="text-align:center;">Jumlah menu</h4>
                  <h1 class="fw-bold" style="text-align:center;"><?= $datamenu['jumlah']?>  <i class="bi bi-clipboard-data"></i></h1>
              </div>
            </div>
          </div>
          <div class="col-lg-3 col-6">
