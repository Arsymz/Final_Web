                    ...
                    <div class="card border-0">
                        <div class="card-header" style="background-color:black;">
                            <div class="d-flex justify-content-between">
                                <h2 class="text-white fw-bold">Tambah menu</h2>
                        ...
                        <div class="card-body" style="background-color:#e4dfdf;">
                            <form action="tambahprosesmenu.php" method="post" enctype="multipart/form-data">
                                ...
                                <div class="mb-4">
                                    <label for="isi_menu" class="form-label">Content</label>
                                    <textarea name="isi_menu" id="isi_menu" class="form-control"></textarea>
                                </div>
                                <div class="mb-4">
                                    <label for="id_kategori" class="category">Category</label>
                                    <select name="id_kategori" id="id_kategori" class="form-select">
                                        <option value="1">Kopi Hot</option>
                                        <option value="2">Food</option>
                                        <option value="3">Non Kopi Hot</option>
                                        <option value="4">Kopi Cold</option>
                                        <option value="5">Snack</option>
                                        <option value="6">Non Kopi Cold</option>
                                    </select>
                                </div>
                                <div class="mb-4">
