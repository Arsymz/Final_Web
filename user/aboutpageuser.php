        ...
        <div class="container-fluid">
          ...
          <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav justify-content-center">
              <li class="nav-item">
                <a class="nav-link text-light" href="indexuser.php">Menu</a>
              </li>
        ...
        <div class="row justify-content-center">
            ...
            <div data-aos="fade-down">
                <div class="card">
                    ...
                    <img src="../anggota/ | M Arsy.jpeg" class="card-img-top" alt="Muhamad  | M Arsy" style="height:300px; width:300px">
                    </div>
...
<h3 class="text-white text-center fw-bold">CAFE</h3>
  ...
  <div class="text-center text-white p-3" style="background-color: rgba(0, 0, 0, 0.2);">
    © 2023 Copyright:
    <a class="text-white" style="text-decoration:none;"> Muh. arsy mawardi mz| Muflih Ramadhan | Nur Fadillah Nur</a>
  </div>
